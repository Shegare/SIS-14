...
public class MapLoadBenchmark
{
    ...
    public static string[] MapsSource { get; } = { "Empty", "Saltern", "Box", "Atlas", "Bagel", "Dev", "CentComm", "Core", "TestTeg", "Packed", "Omega", "Reach", "Meta", "Marathon", "MeteorArena", "Fland", "Oasis", "Convex"};
